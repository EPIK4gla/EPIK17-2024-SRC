...
<div class="container-main">
  <div class="content">
    ...
    <hr>
    <a class="btn-full-width btn-control-md" href="register.php">Register</a>
    <br><br>
    <a class="btn-full-width btn-control-md" href="login.php">Login</a>
    <hr>
    <?php
      $file = 'doc/users.txt';
      $num_users = count(file($file));
      echo "Registered Users: $num_users";
    ?>
  </center>
    </div>
  </div>
