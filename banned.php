<?php
/*if($_SERVER['REMOTE_ADDR'] !== '90.70.184.159') {
...
session_start();
  ...
  $docPath = __DIR__ . '/doc/banned.txt';
...
<link onerror="Roblox.BundleDetector &amp;&amp; Roblox.BundleDetector.reportBundleError(this)" rel="stylesheet" href="https://static.rbxcdn.com/css/page___c6af93a6454b4c1dcca2f80140ef181d_m.css/fetch">
       ...
       <a class="rbx-menu-item" data-toggle="popover" data-bind="popover-setting" data-viewport="#header">
          ...
          <li id="navbar-robux" class="navbar-icon-item">
                <a id="nav-robux-icon" class="rbx-menu-item" data-toggle="popover" data-bind="popover-robux">
                    ...
                    <span class="rbx-text-navbar-right" id="nav-robux-amount">?</span>
                </a>
                <div class="rbx-popover-content" data-toggle="popover-robux">
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="/money" id="nav-robux-balance" class="rbx-menu-item">? Epikbux</a></li>
           ...
           <li id="navbar-notifications" class="navbar-icon-item">
             ...
             <?php
$file_path = __DIR__ . '/doc/notif.txt';
...
if (file_exists($docPath)) {
    ...
    foreach ($bannedUsers as $bannedUser) {
        ...
        if ($userData[0] === $username) {
            $userBanned = true;
            $reviewedDate = isset($userData[1]) ? $userData[1] : '';
            $moderatorNote = isset($userData[2]) ? $userData[2] : '';
            $unbannedDate = isset($userData[3]) ? $userData[3] : '';
...
<div class="not-approved-page-content">
    <div class="not-approved-page">
        <div class="message-container">
            ...
            <p class="message-section">Our content controllers have determined that your behavior on EPIK17 has violated our <a href="" target="_blank">Terms of Use</a>.</p>
            <p class="message-section" id="punishment-created">Reviewed: <b><?php echo $reviewedDate; ?></b> (CT)</p>
            <p class="message-section" id="moderator-note">Moderator note: <b><?php echo $moderatorNote; ?></b></p>
            <p class="message-section" id="punishment-description">Your account has been closed.</p>
            <p class="message-section">To learn more about the appeal process, see <a href="" target="_blank">Appeal Your Content Moderation</a>.</p>
            <p class="message-section">To appeal, go to <a href="" target="_blank">Reports and Appeals</a>.</p>
        </div>
        <div class="action-buttons">
            <div>
                <button type="button" class="btn-control-md btn-min-width" id="logout-button" onclick="window.location = '/logout.php'" data-bind="/logout.php">Quit</button>
            </div>
        </div>
    </div>
</div>
...
?>
<?php include(__DIR__ . '/doc/footer.php'); ?>
</div>